...
def read_financial_transactions_csv(path: str) -> list[dict]:
    """Функция читает из CSV-файла данные о финансовых транзакция и возвращает список словарей"""
...
def read_financial_transactions_excel(path: str) -> list[dict]:
    """Функция читает из Excel-файла данные о финансовых транзакция и возвращает список словарей"""
