...
def test_downloading_financial_transaction_data():
    assert downloading_financial_transaction_data(r"data\operations.json")[1] == {
        "id": 41428829,
        "state": "EXECUTED",
...
def test_get_amount_rub():
    transac = {
        ...
        "operationAmount": {"amount": "4567.89", "currency": {"name": "RUB", "code": "RUB"}},
        "description": "Перевод организации",
...
# Используется декоратор-заглушка path
@patch("src.external_api.requests.get")
def test_get_amount_err_api(moc_get):
    transac = {
        "operationAmount": {"amount": "1000.00", "currency": {"name": "LUNA", "code": "LUNA"}},
    }
